...
const Footer: NextPage<Props> = ({ className }) => {
  return (
    <>
      <div
        className={`${className}  bg-primary/80 pt-40 pb-10 relative text-on-primary`}
      >
        <div className="page-max-width">
          <div className="content-max-width space-y-32">
            <div className="flex flex-col lg:flex-row space-y-10 lg:space-y-0 lg:justify-between items-center">
              <div className="space-y-40 w-5/12">
                ...
                <div className="space-y-20">
                  <div className="py-2 bg-on-primary text-paragraph text-center rounded absolute left-0 w-[46%] -mt-20">
            ...
            <div className="flex justify-end relative text-xl font-medium">
              <div className="flex justify-end space-x-10 relative z-[2]">
                <div>
